function HomePage() {
    ...
    return (
        <div className={`h-[calc(100vh-48px)] w-full bg-no-repeat bg-cover bg-center relative 
            bg-[url('../assets/images/background/todo-bg-mobile.jpg')] 
            md:bg-[url('../assets/images/background/todo-bg-tablet.jpg')] 
            lg:bg-[url('../assets/images/background/todo-bg-desktop.jpg')] 
