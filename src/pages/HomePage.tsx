...
function HomePage() {
    ...
    const { user, titleFromEdit, setTitleFromEdit, fetchDates, setFetchDates, dateFromEdit, setDateFromEdit } = useAuth();
                    ...
                    <div className="px-1">
                        <section className='relative my-5 w-full md:w-2/3 2xl:w-1/2 mx-auto z-10' role='region' aria-labelledby='todo-list-section'>
                            <div className="px-5">
                                ...
                                <SelectDate userId={user.userId} selectedDate={selectedDate} setSelectedDate={setSelectedDate} title={title} fetchDates={fetchDates} setFetchDates={setFetchDates} dateFromEdit={dateFromEdit} setDateFromEdit={setDateFromEdit}  />
