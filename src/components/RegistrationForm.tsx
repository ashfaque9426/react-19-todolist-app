        ...
        <fieldset className="flex flex-col gap-5">
          ...
          <div className="flex flex-col justify-center gap-10">
            ...
            <div className="flex flex-col border-b-2 pb-1.5 relative">
              <input className="for-trans-input peer border-0 outline-0" type="text" name="Name" id="Name" required autoComplete="true" onChange={e => setNameInputValue(e.target.value)} value={nameInputValue} />
            ...
            {/* confirm password */}
            <div className="flex flex-col border-b-2 pb-1.5 relative">
              <input className="for-trans-input peer border-0 outline-0" type={showConfirmPass ? "text" : "password"} name="confirmPassword" id="confirmPassword" required autoComplete="false" onChange={e => setConfirmPassInputValue(e.target.value)} value={confirmPassInputValue} />
